...
import abi from "contracts/MsNFT.json";
import nftMetaData from "nft_metadata.json";
import { contractAddress } from "contracts/contractAddress"
import { NFTStorageMetaDataCID } from "contracts/CID"
  ...
  const mintToken = async (tokenId) => {
    ...
    try {
      if (window.ethereum) {
        ...
        const metadataURI = `https://${NFTStorageMetaDataCID}.ipfs.nftstorage.link`
